...
// alert("click event for PDF file convert")
//    const htmlContent =
...
//   // Change extension to .html so browsers can open it perfectly
//  link.download = `${blog.title.replace(/[^a-z0-9]/gi, '_').toLowerCase()}.pdf`;
...
function Dashboard() {
  ...
  console.log(blogs, "blogs side api ============================");

  console.log(blogs, "form useSelecter side deskboard page");
  ...
  console.log(user, "user form dashboard page");

  console.log(
    user?.id === blogs.map((item) => item.author._id),
    "metching ==========",
  );
